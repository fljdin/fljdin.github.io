...
Les résultats des plans d'exécution précédents s'expliquent ! Pour rappel, nous avions un nœud `Index Scan` pour la recherche « Gauss » et deux nœuds `Bitmap Heap/Index Scan` pour la recherche `Cartan`.
