...
La distribution des valeurs de la colonne `aid` est représentée par le tableau 
...
La commande `ALTER TABLE` suivante permet de modifier les options de stockage de 
